...
class Jakarta extends Component {
    ...
    render() {
        return (
            ...
            <div id="outer">
                <div id="inner">
                    <div id="title-jakarta">Jakarta Sea Level Rise</div>
            ...
            <ScrollAnimation animateOnce animateIn="animate__fadeIn">
                ...
                <ScrollAnimation className="cause" animateOnce animateIn="animate__fadeInUp">

                    <div id="heading">who caused the problem</div>

                    <div id="paragraph-jakarta">Global warming is the primary cause of current sea level rise. As water heats, it expands. These reactions can be seen in all oceans and was the main driver of <a>sea level rise in the past 100 years.</a> The melting of ice glaciers, ice caps and ice sheets is adding even more water to the world's oceans(UCSUSA, 2013). Jakarta is not just sinking because of Global warming, but also because of <a>Land-subsidence.</a> Land-subsidence <a>is a consequence of unmoderated human activity.</a> Land-subsidence is caused by the extraction of large volumes of groundwater from aquifers beneath the city, the sinking is further exacerbated by the soft, swampy ground on which the city sits. Despite some of this extraction being illegal, the city does not have the resources to enforce it effectively and, due to the <a>inadequate provision of drinkable water to many of its districts,</a> the locals often have no alternative.
                ...
                <div className="cause">
                    ...
                    <div id="paragraph-jakarta">The destruction of infrastructure creates large economic deficits, as floods become more common building owners are finding it very costly to do temporary repairs every time. With large floods rendering some builds useless. Jakarta is the heart of Indonesia, both culturally and economically. It contributes the most of any province to Indonesia's GDP with a GRP of about $300 000 USD. If Jakarta sinks into the ocean Indonesia's economy will lose its largest producer and about a 5th of its GDP.
</div>
                    <div id="paragraph-jakarta">
                    Even trying to save the city is becoming a costly project. They will also have to spend a massive amount of money on the giant seawall around $42 billion. That’s the choice coastal cities are increasingly facing, to spend money to adapt now or suffer worse down the road.
                ...
                <div className="cause">
                    ...
                    <div id="paragraph-jakarta">Many forms of wildlife make their home on the beach. As the rising ocean erodes the shoreline and floods the areas in which coastal animals live, animals like shorebirds and sea turtles will suffer. Their nests may be swept away by flooding, an especially big problem for endangered animals like sea turtles that can't afford to lose any offspring. Their habitats may be so damaged by flooding or changes in the surrounding plant life that they can no longer survive in the environment.
                    </div>
                    <div id="paragraph-jakarta">More saltwater hitting our shores will change the chemistry of the soil on the coast, meaning the plant life there will most likely change as well. As rising ocean water seeps into the ground, the soil near the coast will become saltier. Some plants will simply be unable to cope with the change in soil salinity and may disappear from the shoreline. Researchers have claimed that Trees have to work harder to pull water out of salty soil. As a result, their growth can be stunted and if the soil is salty enough, they will die.(Climate Central, 2009). Even though Jakarta is a city, it does contain many large garden and green areas, which are home to many animals and plants.
</div>
                ...
                <div className="cause">
                    ...
                    <div id="paragraph-jakarta">Jakarta’s former governor, Basuki Tjahaja Purnama, tried to tackle several of Jakarta’s big problems. But failed, to wrest control of the water supply from the private companies. He assembled a sanitation crew, called the Orange Army, to remove sediment and garbage from rivers and canals. He cleared out some of the villages that obstructed waterways. The efforts began to make a difference. Rains that once caused days of floods drained within hours. 
</div>
                    <div id="paragraph-jakarta">But many people forced out, resisted the moves, convinced that the evictions were really intended to enrich developers, not improve drainage. These villages became the center of protest against the governor. This conflict was quickly turned into a violent anti-Chinese movement by his political rivals. This issue was turned into an argument about whether a non-Muslim should lead a Muslim-majority city. The governor found himself regularly attacked at Friday prayers. He lost his re-election bid, and the Islamists, who exploited anger against him, had him brought up on charges of blasphemy. He is serving two years in prison(KIMMELMAN, 2017)
</div>
                ...
                <div className="cause">
                    ...
                    <div id="paragraph-jakarta">The country has spent billions to defend itself from rising sea levels. With multiple proposed plans either failing or not being approved by the locals. In 2019 they created a new plan for an offshore seawall, which has gone through its first approval. It is scheduled to begin construction in 2023. The plan proposes a 40km wall along the shore, costing a total of $4 billion plus another 4 billion for pumping stations and reservoirs. Jakarta knows the amount of trouble it is in, and is doing everything they can to delay the inevitable. But with politics and economy at its every step, they have one chance to do it right. 
</div>
                    <div id="paragraph-jakarta">There have been attempts to slow down the temperature increase. For example The Paris Agreement, adopted in 2015 by 175 parties, aims to limit global warming to well below 2°C compared to pre-industrial levels. However, the period 2010-2020 was the planet's hottest decade on record and the long-term trend is upward. As technology spreads, so does the need for energy.  To keep up demands countries are needing to rely heavily on fossil fuels, which has worsened the effects of global warming.
</div>
                    <ScrollAnimation animateOnce animateIn="animate__fadeInUp">
                        <img src="./imgs/kenya/.jpg"/>
                    </ScrollAnimation>
                ...
                <div className="cause">
                    ...
                    <div id="paragraph-jakarta">Although climate change is a large factor in rising sea levels, there is not much Indonesia can do by itself. But what it can do is slow down other factors that are sinking the city. Land-subsidence is causing the city to sink. Stopping this would help decrease the effects of sea level rise. First they need to create a sustainable water management plan to end unmonitored extraction of large volumes of groundwater from aquifers beneath the city. Retrofitting one of the world’s biggest cities with a sewer system is not easy task and will cost billions.

                    </div>

                    <div id="paragraph-jakarta">Secondly, learning from other flooding cities will mitigate the current effects. Creating a 'Waterproof' urban plan prepares the city's infrastructure for large floods. For example in Bangkok, the Centennial Park was established to protect the sinking city from flooding during heavy rainfalls. With artificial wetlands and a water tank below, the park can store up to 4,564 cubic metres of water .
</div>
                    <ScrollAnimation animateOnce animateIn="animate__fadeInUp">
                        <img src="./imgs/kenya/.jpg"/>
                    </ScrollAnimation>
